...
public class LinksOnGrid {
	...
	public void dropdownTest(String b) throws IOException
	{
		...
		FileInputStream f=new FileInputStream("E:\\Aug31Batch\\Selenium\\src\\com\\qedge\\excelfiles\\links.xlsx");
		...
		FileOutputStream f1=new FileOutputStream("E:\\Aug31Batch\\Selenium\\src\\com\\qedge\\resultexcelfiles\\"+b+"_links.xlsx");
		wb.write(f1);
		f1.close();
	}	
